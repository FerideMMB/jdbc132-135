...
public class ExecuteUpdate01 {
    public static void main(String[] args) throws SQLException {
        ...
        //1.Example: Update the number of employees to 16000 if the number of employees is less than the average
        // number of employees
        ...
        System.out.println("numOfRowsUpdated = "+numOfRowsUpdated);//2
